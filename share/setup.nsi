...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\FedoraCoin.lnk" $INSTDIR\fedoracoin-qt.exe
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Uninstall FedoraCoin.lnk" $INSTDIR\uninstall.exe
