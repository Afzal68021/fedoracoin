...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // FedoraCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    printf("FedoraCoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running FedoraCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("FedoraCoinMiner terminated\n");
        throw;
    }
}
