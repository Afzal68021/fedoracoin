...
namespace Checkpoints
{
    ...
    static const CCheckpointData data = {
        &mapCheckpoints,
        1391759966,//1387666072, // * UNIX timestamp of last checkpoint block
        709772,    // * total number of transactions between genesis and last checkpoint
                    //   (the tx=... number in the SetBestChain debug.log lines)
        127019987050, // the chain value up to this block (type getchainvalue <height> to find it)
