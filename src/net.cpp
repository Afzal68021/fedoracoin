...
static const char *strMainNetDNSSeed[][2] = {
    {"fedoracoin.net", "seed.fedoracoin.net"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"fedoracoin.net", "testnet-seed.fedoracoin.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. FedoraCoin is probably already running."), addrBind.ToString().c_str());
        else
